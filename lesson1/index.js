...
*/
const infoAboutMyCity = {
  cityName: 'Tashkent',
  whatCountryMyCity: 'Uzbekiston',
  CountOfPopulationOnMyCity: 2000000,
  thereIsaFootballStadium: true,
}
console.log(infoAboutMyCity)
...
*/
let lenghttOfRectangle = 40
let widthOfRectangle = 70
let unitOfRectangle = 'см'
const areaOfaRectangle = lenghttOfRectangle * widthOfRectangle
const resultAreaOfaRectangle = `${areaOfaRectangle} ${unitOfRectangle}`
console.log(resultAreaOfaRectangle)
...
*/
let time = 2
let speedOfFirstCar = 95
let speedOfSecondCar = 114
let unitOfPath = 'км'
const pathOfFirstCar = time * speedOfFirstCar
const pathOfSecondCar = time * speedOfSecondCar
const pathBetweenCities = pathOfFirstCar + pathOfSecondCar
const resultPathBetweenCities = `${pathBetweenCities} ${unitOfPath}`
console.log(resultPathBetweenCities)
